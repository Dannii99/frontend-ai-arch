...
Los principios generales de a11y (contraste, foco visible, navegación por
teclado) viven en `accessibility-a11y` (core) — no los repitas acá. Lo que sí
es específico de motion y va siempre en cualquier animación no trivial:
